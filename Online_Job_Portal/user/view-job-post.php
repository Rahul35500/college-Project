        ...
        <div class="row">          
          <div class="col-md-9 bg-white padding-2">
            ...
            <div class="pull-right">
              <a href="index.php" class="btn btn-default btn-lg btn-flat"><i class="fa fa-arrow-circle-left"></i> Back</a>
            </div>
          ...
          <div class="col-md-3">
            <div class="thumbnail">
              ...
              <div class="caption text-center">
                ...
                <p><a href="companies.php" class="btn btn-primary btn-flat" role="button">More Info</a>
                <hr>
                <div class="row">
<!--                  <div class="col-md-4"><a href="mailbox.com"><i class="fa fa-warning"></i> Report</a></div>-->
                  <div class="col"><a href="mailbox.php"><i class="fa fa-envelope"></i> Email</a></div>
                </div>
              </div>
            </div>
          </div>
