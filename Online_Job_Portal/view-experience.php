...
<div class="wrapper">
  ...
  ?>
    ...
    <section id="candidates" class="content-header margin-top-50">
      <div class="container">
        <div class="row">          
          <div class="col-md-9 bg-white padding-2">
            <div class="pull-left">
              <h2 style="text-transform:capitalize"><b><i><?php echo $row['companyname']; ?></i></b></h2>
            </div>
          ...
          <div class="col-md-3">
            <div class="thumbnail margin-top-20">
              <img src="uploads/logo/<?php echo $row['logo']; ?>" alt="companylogo">
              <hr>
              <div class="caption text-center">
                <h3 style="text-transform:capitalize"><?php echo $row['companyname']; ?></h3>
                <p><a href="#" class="btn btn-primary btn-flat mine" role="button">More Info</a>
                <hr>
              </div>
            </div>
          </div>
