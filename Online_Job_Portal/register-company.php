        ...
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          ...
          <form method="post" id="registerCompanies" action="addcompany.php" enctype="multipart/form-data">
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                <input class="form-control input-lg" type="email" name="email" placeholder="Email" required  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2, 4}$">
              </div>
              <div class="form-group">
            ...
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                <input class="form-control input-lg" type="text" name="contactno" placeholder="Phone Number" minlength="10" maxlength="10" autocomplete="off"  pattern="[789][0-9]{9}" onkeypress="return validatePhone(event);" required>
              </div>
              <div class="form-group">
